...
<a name="Adapter"></a>
## type [Adapter](<https://github.com/GetTako/tako/blob/main/pkg/adapter/storage/secure/adapter.go#L13-L16>)
...
<a name="New"></a>
### func [New](<https://github.com/GetTako/tako/blob/main/pkg/adapter/storage/secure/adapter.go#L22>)
...
### func [NewWithService](<https://github.com/GetTako/tako/blob/main/pkg/adapter/storage/secure/adapter.go#L31>)
...
### func \(\*Adapter\) [Close](<https://github.com/GetTako/tako/blob/main/pkg/adapter/storage/secure/adapter.go#L63>)
...
### func \(\*Adapter\) [Delete](<https://github.com/GetTako/tako/blob/main/pkg/adapter/storage/secure/adapter.go#L49>)
...
### func \(\*Adapter\) [Get](<https://github.com/GetTako/tako/blob/main/pkg/adapter/storage/secure/adapter.go#L39>)
...
### func \(\*Adapter\) [GetSecret](<https://github.com/GetTako/tako/blob/main/pkg/adapter/storage/secure/adapter.go#L77>)
...
### func \(\*Adapter\) [Has](<https://github.com/GetTako/tako/blob/main/pkg/adapter/storage/secure/adapter.go#L55>)
...
### func \(\*Adapter\) [Set](<https://github.com/GetTako/tako/blob/main/pkg/adapter/storage/secure/adapter.go#L44>)
...
### func \(\*Adapter\) [SetSecret](<https://github.com/GetTako/tako/blob/main/pkg/adapter/storage/secure/adapter.go#L68>)
...
<a name="Provider"></a>
## type [Provider](<https://github.com/GetTako/tako/blob/main/pkg/adapter/storage/secure/provider.go#L10>)
...
### func \(\*Provider\) [Boot](<https://github.com/GetTako/tako/blob/main/pkg/adapter/storage/secure/provider.go#L23>)
...
### func \(\*Provider\) [Name](<https://github.com/GetTako/tako/blob/main/pkg/adapter/storage/secure/provider.go#L13>)
...
### func \(\*Provider\) [Register](<https://github.com/GetTako/tako/blob/main/pkg/adapter/storage/secure/provider.go#L18>)
